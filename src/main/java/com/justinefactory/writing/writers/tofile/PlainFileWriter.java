...
public class PlainFileWriter implements ContentWriter<PlainContent, PathInfo> {

    private final Logger logger = LogManager.getLogger(MethodHandles.lookup().lookupClass());

    @Override
    public void writeContent(PlainContent content, PathInfo fileData) throws ContentWritingException {
